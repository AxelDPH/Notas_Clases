...
Que es un nodo?
Representacion mas basica de lo que eexiste en un DOM, puede ser un elemento o etiqueta, puede ser un atributo, puede ser un texto, incluso un comentario.

     -Document : Nodo raiz, a partir del cual se derivan los demas nodos. Es el objeto a partir del cual se puede acceder a cualquier elemento dentro de el. Todos los nodos derivan de esto.
     
     -Element : son nodos definidos por etiquetas html (div, h1, p, img, meta, head, script, etc), ya sea que se vean o no se vean (etiiquetas que interpreta el navegador),
     ...
     -Comment: los comentarios tambien son un nodos, porque form aparte del documento.
...
Metodos tradicionales 
  -getElementByID (traer un elemento por ID)
  -getElementsByTagName
  -getElementsByClassName
*/
/* aqui obtengo un eleemnto id */
...
la unica diferencia en el querySelector y el getElement, es que teenemos que especificar el tipo de selector que usaremos (para las clases, # para los id)
...
Metodos para modificar elementos
     ...
     - innerHTML: Esta propiedad nos permite acceder y ,modificar el contenido de nuestro elemento.Asignamos una cadena de texto y podemos modificar o eliminar el texto. (ya existe texto) 
